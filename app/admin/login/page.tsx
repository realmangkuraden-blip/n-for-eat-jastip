...
export default function AdminLogin() {
  ...
  return <main className="container flex min-h-[75vh] items-center justify-center py-12">
    <form onSubmit={submit} className="card w-full max-w-md space-y-5 p-8">
      <div><p className="text-sm font-bold text-[#e97827]">JASTIP N GO</p><h1 className="mt-1 text-3xl font-black">Admin Login</h1><p className="mt-2 text-sm opacity-70">Masuk untuk mengelola katalog dan pesanan.</p></div>
