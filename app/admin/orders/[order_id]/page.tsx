...
const labels: Record<string,string> = {pending_payment:'Menunggu pembayaran',payment_verified:'Pembayaran terverifikasi',shopping:'Sedang dibelikan',purchased:'Sudah dibeli',delivering:'Dikirim',completed:'Selesai',cancelled:'Dibatalkan'}
